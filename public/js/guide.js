(function () {
  ...
  var nodes = {
    ...
    out_emergency: {
      ...
      section: { href: "/handbook#reporting", label: "See Section 4 · Emergencies" },
      mail: true
    },
    ...
    out_inside: {
      ...
      section: { href: "/handbook#boundary", label: "See Section 3 · Responsibility boundary" },
      mail: true
    },
    ...
    out_inside_shared: {
      ...
      section: { href: "/handbook#reporting", label: "See Section 4 · Urgent matters" },
      mail: true
    },
    ...
    out_between: {
      ...
      section: { href: "/handbook#boundary", label: "See Section 3 · Damage between apartments" },
      mail: true
    },
    ...
    out_structural: {
      ...
      section: { href: "/handbook#boundary", label: "See Section 3 · Structural failure" },
      mail: true
    },
    ...
    out_shared_routine: {
      ...
      section: { href: "/handbook#reporting", label: "See Section 4 · Routine maintenance" },
      mail: true
    },
    ...
    out_pest_inside: {
      ...
      section: { href: "/handbook#pests", label: "See Section 6 · Pests" },
      mail: true
    },
    ...
    out_spend: {
      ...
      contact: "directors@cotewall-mews.ltd.",
      section: { href: "/handbook#expenditure", label: "See Section 7 · Expenditure" },
      mail: true
    },
    ...
    out_vote: {
      ...
      contact: "directors@cotewall-mews.ltd.",
      section: { href: "/handbook#expenditure", label: "See Section 7 · Voting" },
      mail: true
    },
    ...
    out_quotes: {
      ...
      section: { href: "/handbook#quotes", label: "See Section 5 · Quotes" },
      mail: true
    },
    ...
    out_improvement: {
      ...
      contact: "directors@cotewall-mews.ltd.",
      section: { href: "/handbook#expenditure", label: "See Sections 4 and 7" },
      mail: true
    },
    ...
    out_sale: {
      ...
      contact: "directors@cotewall-mews.ltd.",
      section: { href: "/handbook#sale", label: "See Section 8 · Pre-contract enquiries" },
      mail: true
    },
    ...
    out_pets: {
      ...
      section: { href: "/handbook#sale", label: "See Section 8 · Pets" },
      mail: true
    },
    ...
    out_neighbour: {
      ...
      section: { href: "/handbook#reporting", label: "See Section 4 · Disagreements" },
      mail: true
    },
    ...
    out_general: {
      ...
      section: { href: "/handbook#summary", label: "See Section 11 · Summary" },
      mail: true,
      extra: { href: "/handbook#contacts", label: "See Section 9 · Contacts" }
    }
  };
  ...
  function render(id) {
    ...
    if (node.result) {
      ...
      html +=
        '<a class="secondary" href="/handbook#documents">Society documents</a>';
      if (node.mail) {
